# CLAUDE.md — Jarvis AI Agent System Prompt & Schema
...
├── .gitignore
├── .exportignore
└── CLAUDE.md                     # Ushbu yo'riqnoma fayli.
```
...
## Page Formats (Sahifa formatlari)

Barcha wiki sahifalari yuqori qismida YAML frontmatterga ega bo'lishi kerak.

### concepts/NAME.md
```markdown
---
title: "Tushuncha nomi"
domain: marketing | ai_automation | kasbtech_academy | personal
tags: []
source_count: N
...
## Ta'rifi
Tushunchaning oddiy va professional ta'rifi.

## Biznesdagi ahamiyati

## Asosiy Manbalar
- [[sources/slug]] — manba tavsifi.
```
...
---
title: "Ob'ekt nomi"
entity_type: person | org | product | project | car | laptop
domain: marketing | ai_automation | kasbtech_academy | personal
last_updated: YYYY-MM-DD
---
...
## Tafsilotlar (Faktlar)
- Fakt (manba: [[sources/slug]])
```

---

## Maxsus Qoidalar (Discipline Rules)

1. **Tarixni o'zgartirmang**: `wiki/log.md` va `sessions/` jurnallarini hech qachon tahrirlamang.
2. **Haqiqiy havolalar**: Faqat mavjud yoki yaratilayotgan sahifalarga wikilinklar bering, uydirma havolalar qo'ymang.
3. **Muloqot**: Javoxir Aliyev bilan doim do'stona, hurmatli va professional Jarvis personasida gaplashing.
